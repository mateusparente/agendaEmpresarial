...
<script src="<c:url value='/validacoesFormularios/regras_edita_funcionario.js'/>"></script>
</head>
<body>
...
<div class="col-sm-10">
<input type="text" name="funcionario.nome" class="form-control" id="Nome" value="${funcionario.nome}" autofocus>
</div>
</div>
